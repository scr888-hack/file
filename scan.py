...
#===june=======================================================================#
#maxgie = LINE('ENPAK0BuEFw5qw4LPZIe.GFQUSPSIC0Wl5GgIVs3c3G.2t5qpnU+Rx7ygrKGLhhdUxq/VkzNQcja5a1fQRbXSvg=')
#=====Tumz=====================================================================#
#maxgie = LINE('ENfvgaBkKv2LE9z5Pbif.jnx5p5etYze0laEqbuz/lW.te4wlY76zGptshd4uzE+Rexb4ZSXdzQf8lkEfU47Hwc=')
#=====botslotth=====================================================================#
maxgie = LINE('ENfjo7moCcBeZpIKBpb6.NFKafgICO4hV5RYJS6PDHG.ITQ8mTzXwYlgOdB4CH4n2LZnybG7xksfMU5H0DK50r0=')
#maxgie = LINE('')
    ...
    try:
        ...
        if op.type == 15:
          if settings["Leave"] == True:
            ...
            s = "#FF0000"
            sa = """📌Hiallbet อาณาจักรเดิมพัน รวม 14 เว็บ
            ...
            dataProfile = [
                {
                    ...
                    "header": {
                        ...
                        "contents": [
                            {
                                "type": "image",
                                "url": 'https://data.bloggif.com/distant/user/store/b/7/c/c/f454e349d438710ef0843849063ccc7b.gif',
                                "size": "full"
                            },
                            {
                                "type": "text",
